				...
				<div class="sidebar">
					<div class="sidebar__item">
						...
						<ul>
							...
							<li><a href="loanStatusList.do"
								style="color: var(--main-light-brown)">도서이용정보</a></li>
						...
						<div class="latest-product__text">
							...
							<div class="latest-product__slider owl-carousel">
								<div class="latest-prdouct__slider__item">
									<c:forEach items="${recomendList }" var="recommend" begin="0"
										end="2" step="1">
										<a href="detailbook.do?isbn=${recommend.isbn }"
								...
								<div class="latest-prdouct__slider__item">
									<c:forEach items="${recomendList }" var="recommend" begin="3"
										end="5" step="1">
										<a href="detailbook.do?isbn=${recommend.isbn }"
											class="latest-product__item">
											<div class="latest-product__item__pic">
				...
				<div class="product__discount">
					...
					<div class="row">
						...
						<div class="col-lg-7 menu">
							<a href="loanStatusList.do">이북도서</a> <a
								href='loanDeliveryStatusList.do'>배송도서</a> <a
								href='loanHistory.do'>대출이력</a>
						</div>
										...
										<tbody>
											<c:if test="${not empty books }">
												<c:forEach items="${books }" var="book" varStatus="status">
													<c:if test="${not empty book.rdate }">
														...
														<tr onmouseover="this.style.background='#eae0d7'" onmouseout="this.style.background='white'">
															...
															<td><c:set var="bend"
																	value="${ fn:substring(book.rdate,0,10)}" />
