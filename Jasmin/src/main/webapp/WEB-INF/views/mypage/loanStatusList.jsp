		...
		<div class="row">
			...
			<div class="col-lg-9 col-md-7">
				<div class="product__discount">
					...
					<div class="container">
						<div class="row">
							<div class="list_total">대출 현황 <strong>${fn:length(books) }</strong>건</div>
							<div class="col-lg-12">
										...
										<tbody>
											<c:if test="${not empty books }">
												<c:forEach items="${books }" var="book" varStatus="status">
													<c:if test="${empty book.rdate && book.deliveryn eq 'N'}">
														...
														<tr onmouseover="this.style.background='#eae0d7'" onmouseout="this.style.background='white'">
															...
															<td onclick="location.href='detailbook.do?isbn=${book.isbn }'"><c:set var="bstart"
															...
															<td><button id="returnBtn${status.count }"
																	class="site-btn site-btn3" onclick="returnAjaxFnc(${book.isbn})">반납</button></td>
